...
class gteaHandLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        lbl_path = pjoin(self.root, "MasksProcessed", im_name + ".png")
...
if __name__ == '__main__':
    local_path = '/cvlabdata2/home/user/data/GTEA'
    ...
    dst = gteaHandLoader(root=local_path, is_transform=True, augmentations=aug)
    bs = 2
